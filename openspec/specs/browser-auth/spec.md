# Browser Auth Specification

## Purpose

Admin-triggered authentication flow that opens a visible Playwright browser so operators can log in to target sites manually, persisting the resulting session for subsequent script runs.
