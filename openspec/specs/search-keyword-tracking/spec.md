# Search Keyword Tracking Specification

## Purpose

Each notice record stores the search keyword that produced it, enabling filtering and attribution in the admin dashboard.
