# Run Screenshot Specification

## Purpose

Before each step-1 ID collection run, the runner captures a PNG screenshot of the search results page for verification and audit purposes.
